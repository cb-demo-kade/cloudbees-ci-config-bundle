...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/cb-demo-kade/pipeline-template-catalog.git");
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>cb-demo-kade</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/cb-demo-kade/pipeline-template-catalog.git</repositoryUrl>
              <traits>
